...
// QCOM and MTK54 use standard GPIO definition
	...
	pr_debug(
		"%s : debug irq_gpio = %d, client-irq =  %d\n",
		__func__,
...
static const struct i2c_device_id st21nfc_id[] = { { "st,st21nfc", 0 }, {} };
