 ...
 */
#define ST21NFC_GET_WAKEUP                  _IO(ST21NFC_MAGIC, 0x01)	//# define _IO(x,y)       (((x)<<8)|y)
...
#define ST21NFC_LEGACY_SET_POLARITY_RISING  _IOR(ST21NFC_MAGIC, 0x03, unsigned int)
#define ST21NFC_LEGACY_SET_POLARITY_FALLING _IOR(ST21NFC_MAGIC, 0x04, unsigned int)
