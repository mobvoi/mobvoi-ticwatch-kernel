...
extern struct sdio_func * get_func_pointer(void);
...
int dhd_wifi_init_gpio(void)
{
	...
	if (gpio_direction_output(gpio_wl_reg_on, 0))
		pr_err("%s: WL_REG_ON failed to pull down\n", __func__);
	else
		BCM_DBG("%s: WL_REG_ON is pulled down\n", __func__);
...
static struct cntry_locales_custom brcm_wlan_translate_custom_table[] = {
	...
	{"BN", "BN", 4},
	{"BR", "BR", 2},
	{"CA", "US", 988},   /* Previousely was CA/31 */
	{"CH", "CH", 4},
	{"CN", "CN", 38},
	{"CY", "CY", 4},
	{"CZ", "CZ", 4},
