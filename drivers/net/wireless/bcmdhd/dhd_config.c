...
const cihp_name_map_t chip_name_map[] = {
	...
	{BCM43430_CHIP_ID,	0,	DONT_CARE,	"bcm43438a0",		"43438a0"},
	{BCM43430_CHIP_ID,	1,	DONT_CARE,	"bcm43438a1",		"43438a1"},
	{BCM43430_CHIP_ID,	2,	DONT_CARE,	"bcm43436b0",		"43436b0"},
	{BCM43012_CHIP_ID,	1,	FW_TYPE_G,	"bcm43013b0",		"43013b0"},
	{BCM43012_CHIP_ID,	1,	FW_TYPE_AG,	"bcm43013c0_ag",	"43013c0"},
	...
	{BCM43752_CHIP_ID,	1,	DONT_CARE,	"bcm43751a2_pcie_ag",	""},
#endif
#ifdef BCMDBUS
...
void
dhd_conf_set_path_params(dhd_pub_t *dhd, void *sdh, void *sih,
...
#ifdef BCMSDIO
	dhd_conf_set_fw_name_by_mac(dhd, (bcmsdh_info_t *)sdh, (si_t *)sih, fw_path);
	dhd_conf_set_nv_name_by_mac(dhd, (bcmsdh_info_t *)sdh, (si_t *)sih, nv_path);
#endif
...
dhd_conf_set_wl_preinit(dhd_pub_t *dhd, char *data)
{
	...
	while (pick_tmp && (pick_tmp2 = bcmstrtok(&pick_tmp, ",", 0)) != NULL) {
		...
		if (ret) {
			...
			dhd_conf_set_intiovar(dhd, cmd, name, val, -1, FALSE);
		}
	}
