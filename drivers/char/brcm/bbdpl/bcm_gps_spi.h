...
// #define TRANSPORT_RX_BUFFER_SIZE          6144      ///< Transport receive buffer size, bytes
...
// #define MAX_SPI_FRAME_LEN (BCM_SPI_READ_BUF_SIZE / 8)  // TODO: MAX_SPI_FRAME_LEN = 8K should be less TRANSPORT_RX_BUFFER_SIZE, Now it is 12K (SWGNSSAND-1647)
#define MAX_SPI_FRAME_LEN (1024 * 8)                      // TODO : hardcoded because of Tizen has PAGE_SIZE == 8K not 4K as it is expected. Need to confirm.
